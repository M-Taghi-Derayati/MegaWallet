 ...
 */
 object MainScreenConstants {
    ...
    val BOTTOM_NAV_DIVIDER_HEIGHT = 0.6.dp
    val BOTTOM_NAV_DIVIDER_ALPHA = 0.1f
    
    // FAB
    val FAB_SIZE = 56.dp
    val FAB_EXPANDED_HEIGHT = 280.dp
    val FAB_CORNER_RADIUS_EXPANDED = 32.dp
    val FAB_CORNER_RADIUS_COLLAPSED = 28.dp
    val FAB_HORIZONTAL_PADDING = 16.dp
    ...
    val FAB_MENU_ITEM_CORNER_RADIUS = 20.dp
    ...
    val FAB_MENU_ITEM_BACKGROUND = Color(0xFF181818)
