...
fun AutoImportWordKeys(
    ...
    val subtitle = stringResource(com.mtd.megawallet.R.string.import_wallet_subtitle_12_key)
    ...
    val manualImportText = "وارد کردن دستی"
    ...
    Box(
        ...
        Column(
            ...
            PrimaryButton(
                text = addButtonText,
                onClick = { onVerificationSuccess(words) },
                enabled = isValid,
