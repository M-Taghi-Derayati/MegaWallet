...
class Interpolators(private val easing: Easings) : Interpolator {
    ...
    private fun bounceInOut(t:Float): Float {
        if (t<0.5) {
            val tt=1-2*t
            return when {
                tt < (1/2.75) -> ((1 - (7.5625*t*t))/2).toFloat()
                tt < (2/2.75) -> ((1 - (7.5625*(t-(1.5/2.75))*(t-(1.5/2.75)) + 0.75))/2).toFloat()
                tt < (2.5/2.75) -> ((1 - (7.5625*(t-(2.25/2.75))*(t-(2.25/2.75)) + 0.9375))/2).toFloat()
                else -> ((1 - (7.5625*(t-(2.625/2.75))*(t-(2.625/2.75)) + 0.984375))/2).toFloat()
            }
        } else {
            val ttt=2*t-1
            return when {
                ttt < (1/2.75) -> (0.5 + (7.5625*t*t)/2).toFloat()
                ttt < (2/2.75) -> (0.5 + (7.5625*(t-(1.5/2.75))*(t-(1.5/2.75)) + 0.75)/2).toFloat()
                ttt < (2.5/2.75) -> (0.5 + (7.5625*(t-(2.25/2.75))*(t-(2.25/2.75)) + 0.9375)/2).toFloat()
